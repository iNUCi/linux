...
static const struct x86_cpu_id mid_pb_cpu_ids[] = {
	X86_MATCH_VFM(INTEL_ATOM_SALTWELL_MID,	&mfld_ddata),
	X86_MATCH_VFM(INTEL_ATOM_SALTWELL_TABLET,	&mfld_ddata),
	X86_MATCH_VFM(INTEL_ATOM_SILVERMONT_MID,	&mrfld_ddata),
	{}
};
...
static void mid_pb_remove(struct platform_device *pdev)
{
